...
Run or review `scripts/intake.sh --project truthwatcher --dry-run` first. If the output is appropriate, rerun without `--dry-run` only for Mistspren artifacts that humans can review.
