# Mistspren truthwatcher-review Prompt
...
Run or review `scripts/truthwatcher-review.sh --project truthwatcher --dry-run` first. If the output is appropriate, rerun without `--dry-run` only for Mistspren artifacts that humans can review.
