...
Run or review `scripts/promote.sh --project truthwatcher --dry-run` first. If the output is appropriate, rerun without `--dry-run` only for Mistspren artifacts that humans can review.
